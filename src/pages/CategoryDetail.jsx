...
import { Header, FilterBar, CategorySection, SkeletonLoader } from "../components";
  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 py-8 sm:py-12 md:py-16 flex flex-col gap-4 items-center">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold font-noto mb-4">
          {t("categories.chooseFav")}
        </h1>
        <p className="text-dark-gray text-base md:text-lg">
